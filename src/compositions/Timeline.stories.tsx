...
export const Default: Story = {
  args: {
    events: [
      { status: "ok", time: "12:04", message: "Node restarted successfully", detail: "All 12 DC connections re-established" },
      { status: "error", time: "12:02", message: "Connection to SYD lost" },
      { status: "warn", time: "11:58", message: "CPU spike detected — 94%", detail: "Duration: 12s" },
