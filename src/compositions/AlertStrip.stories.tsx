...
export const Default: Story = {
  args: {
    alerts: [
      { severity: "crit", message: "Node health below 50%", source: "health-monitor", timestamp: "12:04" },
      { severity: "warn", message: "Memory usage exceeded 85%", source: "resource-watcher", timestamp: "12:01" },
