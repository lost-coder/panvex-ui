...
const mockServer: any = {
  ...
  mePool: {
    ...
    writersList: [
      { writerId: 1, dc: 1, endpoint: "91.108.1.1:8888", state: "active", degraded: false, draining: false, rttEmaMs: 12.3, boundClients: 45, idleForSecs: undefined },
      { writerId: 2, dc: 1, endpoint: "91.108.1.2:8888", state: "active", degraded: true, draining: false, rttEmaMs: 85.1, boundClients: 12, idleForSecs: 5 },
      { writerId: 3, dc: 2, endpoint: "91.108.2.1:8888", state: "active", degraded: false, draining: false, rttEmaMs: 22.0, boundClients: 38, idleForSecs: undefined },
    ],
  },

  upstreams: [
    { upstreamId: 0, routeKind: "direct", address: "0.0.0.0:443", weight: 1, dc: 1, healthy: true, fails: 0, effectiveLatencyMs: 0, lastCheckAgeSecs: 5 },
    { upstreamId: 1, routeKind: "direct", address: "0.0.0.0:8443", weight: 1, dc: 1, healthy: true, fails: 0, effectiveLatencyMs: 1, lastCheckAgeSecs: 3 },
    { upstreamId: 2, routeKind: "socks5", address: "proxy.example.com:1080", weight: 1, dc: 2, healthy: false, fails: 3, effectiveLatencyMs: 450, lastCheckAgeSecs: 120 },
  ],
  upstreamSummary: { configuredTotal: 3, healthyTotal: 2, unhealthyTotal: 1, directTotal: 2, socks5Total: 1, socks4Total: 0, shadowsocksTotal: 0 },
  ...
  selftest: {
    ...
    timeskew: { state: "ok", maxSkewSecs15m: 0.3, samples15m: 15, lastSkewSecs: 0.1, lastSource: "NTP" },
    ip: {
  ...
  natStun: {
    ...
    configuredServers: ["stun.l.google.com:19302", "stun1.l.google.com:19302", "stun2.l.google.com:19302"],
  },

  events: [
    { seq: 1, tsEpochSecs: now - 60, eventType: "config_reload", context: "Config reloaded successfully" },
    { seq: 2, tsEpochSecs: now - 300, eventType: "writer_degraded", context: "Writer 2 DC1 high RTT" },
    { seq: 3, tsEpochSecs: now - 900, eventType: "upstream_fail", context: "proxy.example.com:1080 health check failed" },
